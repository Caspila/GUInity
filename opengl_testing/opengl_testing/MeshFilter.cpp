...
void MeshFilter::getBoxSize(shared_ptr<Actor> actor, PxVec3& boxSize, PxVec3& center)
{
...
void MeshFilter::getSphereSize(shared_ptr<Actor> actor, float& radius, PxVec3& center)
{
...
void MeshFilter::getCapsuleGeometry(shared_ptr<Actor>actor,float &radius,float &halfHeight,RotateAxis&orientation,PxVec3& center)
{
    PxVec3 boxSize(mesh->boundsMax.x - mesh->boundsMin.x,
                   mesh->boundsMax.y - mesh->boundsMin.y,
                   mesh->boundsMax.z - mesh->boundsMin.z);
